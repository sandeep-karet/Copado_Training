({
    doInit : function(component, event, helper) {
        component.set("v.errorMsg", "UNABLE TO TRANSFER LEAD : \n LastName, FirstName, Company, Phone, and Email are required fields \n Status must be AQL or MQL \n Transfer To field can not be empty\n");
                    ...
                    if (details.isInsert == 'true') {    
                        ...
                        if (details.result.includes("internal error")) {
                            ...
                            toastEvent.setParams({
                                ...
                                "message": 'This record already exists in the other org instance',
                                "mode": "sticky"
                            });
                            toastEvent.fire();
                        } else { 
